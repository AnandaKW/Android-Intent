package sch.id.www.myintentapp;
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.btn_move_activity_data:
                ...
                intent.putExtra("data1", "somestringdata");
                intent.putExtra("data2", "somestringdata2");
                startActivity(intent);
                break;
            case R.id.btn_move_activity_object:
                Person manusia = new Person("Ananda", "ananda@gmail.com", "Malang", 16);
